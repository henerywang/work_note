...
// #include <linux/types.h>  //结构体list_head，hlist_head ，hlist_node 的定义
// #include <linux/stddef.h> //宏offsetof
// #include <linux/poison.h> //宏LIST_HEAD_INIT(name)，LIST_HEAD(name)
// #include <linux/prefetch.h> //宏prefetch(x) 
